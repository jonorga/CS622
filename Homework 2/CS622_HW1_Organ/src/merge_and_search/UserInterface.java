...
public class UserInterface {
	...
	public UserInterface() {
		...
		searchHistory = new SearchHistory(findFiles.getCurrentPath());
		...
		try
		{
			...
			while (running) {
				System.out.println("Choices - 1: merge found files, 2: change data directory, 3: search for term, 4: print search history, 5: quit");
				...
				if (selection == 49) {
					...
					searchHistory.addSearchQuery(term);
